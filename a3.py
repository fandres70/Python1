...
def board_contains_word(board, word):
    ...
    return (board_contains_word_in_row(board, word)
            or board_contains_word_in_column(board, word))
...
def num_words_on_board(board, words):
    ...
    for word in words:
        hits = hits + board_contains_word(board, word)
    return hits
...
def read_board(board_file):
    ...
    for row_str in board_file:
        row_str = row_str.rstrip('\n')
        row_lst = []
        for letter in row_str:
            row_lst.append(letter)
